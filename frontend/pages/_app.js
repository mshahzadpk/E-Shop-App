...
import AuthProvider from "@/components/AuthProvider/AuthProvider"; // Import the AuthProvider component
...
export default function App({ Component, pageProps }) {
  return (
    <>
      {/* Head section for setting up metadata and favicon */}
      <Head>
        <title>E-Shop</title>
        ...
        <link
          ...
          crossOrigin="true"
        />
        {/* Uncomment below line to add custom fonts */}
        {/* <link
      ...
      {/* Redux Provider to provide the store to components */}
